...
Companion to Chapter 6 in [BOOK.md](../BOOK.md#chapter-6).
...
A non-exhaustive list of useful `gh copilot suggest` prompts for AI/ML work — see Chapter 6 §6.7 in [BOOK.md](../BOOK.md#chapter-6) for the full list with expected commands.
...
[Phase 7 — Agentic AI with Copilot / MCP](../Phase7_Agentic_AI_Copilot/README.md).
