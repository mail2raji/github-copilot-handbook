...
This folder is the **companion** to Chapter 0 in [BOOK.md](../BOOK.md#chapter-0). Read it for orientation; do the drills here.
...
Move to [Phase 1 — Git Fundamentals](../Phase1_Git_Fundamentals/README.md).
